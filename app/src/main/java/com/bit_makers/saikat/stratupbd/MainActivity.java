...
public class MainActivity extends AppCompatActivity
    ...
    ListView listView;
    String[] title, author, comment, time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(R.id.containerView, new AllArticle(MainActivity.this)).commit();
    ...
    private void setArticle(){
        ...
        for(int i=0; i<6; i++){
            ...
            article.setCommment(comment[i]);
            article.setDate(time[i]);
